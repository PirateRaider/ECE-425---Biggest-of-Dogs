...
/*
  The followWall function uses a variety of variables to try and keep the robot within a dead band of 4-6 inches from the wall. Currently, these values ar hardcoded.
...
/*
  goToGoal command keeps track of the robots distance in X & Y space to allow the robot to move around any obstacle. This assumes the object is oriented parallel or perpendicular
  to the robot's starting configuration. 
...
void loopM7() {
  struct light data = RPC.call("read_lights").as<struct light>();
